...
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1003013971591'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1003013971591'))  # Verified user actions log
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003013971591"))
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'PP_down_bot')  # Owner's username
BOT_USERNAME = environ.get("BOT_USERNAME", 'PP_down_bot')  # Bot's username
...
FQDN = getenv("FQDN", "mature-phillida-rvasp-file-store-a53f8c09.koyeb.app/") or BIND_ADDRESS  # Full domain name or fallback to bind address
